...
for (const album of albums) {
    if(album.genre === "Rock"){ //si el genero del album es estrictamente igual a 'Rock'
        totalDuration += album.duration //se suma el valor en la clave 'duration'
    }
}
console.log("La duración total de los albumes de rock es de", totalDuration, "minutos")